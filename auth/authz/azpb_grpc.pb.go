...
func (c *whoamiClient) Me(ctx context.Context, in *MeRequest, opts ...grpc.CallOption) (*MeResponse, error) {
	out := new(MeResponse)
	err := c.cc.Invoke(ctx, "/azpb.Whoami/Me", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedWhoamiServer) Me(context.Context, *MeRequest) (*MeResponse, error) {
...
func _Whoami_Me_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WhoamiServer).Me(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/azpb.Whoami/Me",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WhoamiServer).Me(ctx, req.(*MeRequest))
	}
...
var Whoami_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "azpb.Whoami",
	HandlerType: (*WhoamiServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Me",
			Handler:    _Whoami_Me_Handler,
		},
	},
